<?php
/**
 * Team post grid partial.
 * Default partial for team post inside grid.
 */
global $post;
...
$iki_terms          = Iki_Toolkit_Utils::get_term_name_and_link( $post->ID, 'iki_team_member_cat', 2 );
$iki_post_permalink = esc_url( get_permalink() );
?>
