...
if ( ! empty( $iki_post_subtitle )
     && 'classic' == $iki_row_data->type
     && 'square' == $iki_row_data->orientation
     && 4 == $iki_row_data->cells
) {
	//truncate subtitle
	...
	<div class="iki-cell-info-wrap">
		<?php if ( ! empty( $iki_terms ) ) { ?>
			<div class="iki-cell-term-wrap">
				<a href="<?php echo esc_url( $iki_terms[0]['link'] ); ?>"
				   class="iki-cell-term" <?php echo Iki_Toolkit_Utils::get_taxonomy_colors( $iki_terms[0]['id'], 'category' ) ?>>
					<?php echo esc_html( $iki_terms[0]['name'] ); ?></a>
			</div>
		<?php } ?>
		<a class="iki-cell-link" href="<?php echo $iki_post_permalink ?>">
			...
			<?php } ?>
			<div class="iki-cell-date"><?php echo esc_html( get_the_date() ); ?></div>
		</a>
	</div>
</div>
