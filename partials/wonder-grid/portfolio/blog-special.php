<?php
/**
 * Portfolio special grid partial
...
$iki_terms          = Iki_Toolkit_Utils::get_term_name_and_link( $post->ID, 'iki_portfolio_cat' );
		...
		<?php if ( ! empty( $iki_terms ) ) { ?>
			<div class="iki-cell-term-wrap">
				<a class="iki-cell-term"
					<?php echo Iki_Toolkit_Utils::get_taxonomy_colors( $iki_terms[0]['id'], 'iki_portfolio_cat' ) ?>
