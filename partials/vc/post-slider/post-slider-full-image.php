<?php
/**
 * Blog post slider shortcode partial
 *
 * available variables:
...
$iki_post_format_video = ( 'video' == get_post_format() );
?>
	<div class="iki-vc-post <?php echo 'iki-vc-t-' . $iki_post_type ?>">
		...
		<?php } ?>
		<div class="iki-vc-p-image-title-wrap <?php echo  iki_toolkit_vc_get_responsive_class($layout['image_orientation'])?>">
