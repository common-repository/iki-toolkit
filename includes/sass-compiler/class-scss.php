...
class iki_themes_scssc {
	...
	protected $formatter = 'iki_themes_scss_formatter_nested';
	...
	public function compile( $code, $name = null ) {
		...
		$this->parser = new iki_themes_scss_parser( $name );
	...
	protected function injectVariables( array $args ) {
		...
		$parser = new iki_themes_scss_parser( __METHOD__, false );
	...
	protected function importFile( $path, $out ) {
		...
		if ( isset( $this->importCache[ $realPath ] ) ) {
			...
			$parser              = new iki_themes_scss_parser( $path, false );
...
class iki_themes_scss_parser {
	...
	static protected function makeOperatorStr( $operators ) {
		return '(' . implode( '|', array_map( array( 'iki_themes_scss_parser', 'preg_quote' ),
				$operators ) ) . ')';
	}
	...
	protected function selectorSingle( &$out ) {
		...
		while ( true ) {
			...
			// self
			if ( $this->literal( '&', false ) ) {
				$parts[] = iki_themes_scssc::$selfSelector;
				continue;
			}
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class iki_themes_scss_formatter {
	public $indentChar = '  ';
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class iki_themes_scss_formatter_nested extends iki_themes_scss_formatter {
	public $close = ' }';
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class iki_themes_scss_formatter_compressed extends iki_themes_scss_formatter {
	public $open = '{';
	public $tagSeparator = ',';
	public $assignSeparator = ':';
	public $break = '';
 ...
 */
class iki_themes_scss_formatter_crunched extends iki_themes_scss_formatter {
	public $open = '{';
	public $tagSeparator = ',';
	public $assignSeparator = ':';
	public $break = '';
...
class iki_themes_scss_server {
	...
	public function __construct( $dir, $cacheDir = null, $scss = null ) {
		...
		if ( ! isset( $cacheDir ) ) {
			$cacheDir = $this->join( $dir, 'iki_themes_scss_cache' );
		}
